...
from Hourglass_module import Hourglass_module
...
class CornerNet(nn.Module):
    ...
    def forward(self, *xs):
        ...
        layers = zip(
            self.Hourglass_modules, self.cnvs,
            self.corner_pools,
