...
# Docker
train_annotation_path   = "../CornerNet/BDD100K/bdd100k_labels_images_train.json"           # bdd100k_labels_images_train.json[0:60000]
val_annotation_path     = "../CornerNet/BDD100K/bdd100k_labels_images_val.json"               # bdd100k_labels_images_train.json[60000:]
test_annotation_path    = "../CornerNet/BDD100K/bdd100k_labels_images_test.json"             # bdd100k_labels_images_val.json
train_image_root        = "../CornerNet/BDD100K/train/"
val_image_root          = "../CornerNet/BDD100K/val/"
...
class Dataset(Dataset):
    def __init__(self, mode):
        ...
        self.input_size = [360, 640]     # Original_input_size / 2 
        self.output_size = [90, 160]     # Original_input_size / 8 
